...
except ImportError as exc:  # pragma: no cover - defensive guard for missing optional dependency
    raise ImproperlyConfigured(
        "The package 'python-dotenv' is required to load environment variables. "
        "Ensure it is installed (e.g., pip install python-dotenv) and listed in your requirements."
    ) from exc
...
try:
    ...
    raise ImproperlyConfigured(
        "The package 'dj-database-url' is required for database configuration. "
        "Ensure it is installed (e.g., pip install dj-database-url) and listed in your requirements."
    ) from exc
...
database_url = os.environ.get('SAFETNET_DATABASE_URL', '')
